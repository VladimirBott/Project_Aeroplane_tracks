...
class TestNominatimAPI(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.client._base_url, 'https://nominatim.openstreetmap.org/search')
...
class TestOpenSkyAPI(unittest.TestCase):
    ...
    def test_init(self):
        """Проверка инициализации."""
        self.assertEqual(self.client._base_url, 'https://opensky-network.org/api/states/all')
...
class TestAircraftDataFetcher(unittest.TestCase):
    ...
    def test_get_aircraft_data_success(self, MockOpenSkyAPI, MockNominatimAPI):
        ...
        mock_opensky.get_aircraft_in_area.assert_called_once_with(['40', '50', '-10', '10'])
